...
public class GDConstructive extends Constructive<GDSolution, GDInstance> {
    ...
    public GDConstructive(double SE_w1, double SE_w2, double LE_w1, double LE_w2, int iterations, double tabuSize, InputVertexSelectionCriteria selectionCriteria, HostVertexCriteria hostVertexCriteria, LongEdgeSelectionCriteria longEdgeSelectionCriteria, LongEdgeLocationCriteria longEdgeLocationCriteria) {
        this.LE_w1 = LE_w1;
        this.LE_w2 = LE_w2;
        this.SE_w1 = SE_w1;
        this.SE_w2 = SE_w2;
...
//                i--;
    ...
    public String toString() {
        return "C{" +
                ...
                "-it=" + iterations +
                "-tS=" + tabuSize +
                "-lES=" + longEdgeSelectionCriteria +
                "-lEL=" + longEdgeLocationCriteria +
                "-vS=" + selectionCriteria +
                "-vL=" + hostVertexCriteria +
                '}';
    }
