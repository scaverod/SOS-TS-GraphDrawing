...
public class GDGurobiRafa extends Algorithm<GDSolution, GDInstance> {

    private static final Logger log = LoggerFactory.getLogger(GDGurobiRafa.class);
    ...
    public GDGurobiRafa(int time, TimeUnit timeUnit) {
        try {
    ...
    protected GRBEnv initializeEnvironment(long timeSeconds) throws GRBException {
        ...
        env.set(GRB.IntParam.Threads, GDGurobiRafa.NUMBER_OF_THREATS);
        env.start();
        return env;
    }
